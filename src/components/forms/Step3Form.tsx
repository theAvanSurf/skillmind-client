  ...
  return (
    ...
    >
      <div className="relative">
        <div className="h-16 w-16 overflow-hidden rounded-full border-2 border-white/10 bg-white/6 transition group-hover:border-orange-500/60">
          <img src={profile.profilePhotoUrl} alt={profile.profileName} className="h-full w-full object-cover" />
        </div>
        {profile.kidsProfile && (
          <span className="absolute -bottom-0.5 -right-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-blue-500 ring-2 ring-[#07071a]">
...
function EmptySlot({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="group flex flex-col items-center gap-1.5"
    >
      <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-dashed border-white/15 bg-white/3 transition group-hover:border-orange-500/40 group-hover:bg-white/[0.07]">
        <Plus size={20} className="text-white/25 transition group-hover:text-orange-400" />
      </div>
    ...
    <AuthLayout step={3} totalSteps={5} title="Profiles" wide>
      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:gap-8">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="relative">
            ...
            <span className="absolute -bottom-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full bg-orange-500 shadow-lg ring-2 ring-[#07071a]">
      ...
      <div className="mt-5 flex gap-3">
        ...
        <button
          type="button"
          onClick={handleSave}
          className="flex-1 rounded-xl bg-linear-to-r from-orange-500 to-orange-600 py-3 text-sm font-semibold text-white shadow-lg shadow-orange-500/25 transition hover:from-orange-600 hover:to-orange-700"
        >
