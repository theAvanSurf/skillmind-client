          ...
          <div className="absolute bottom-0 left-0 w-full p-5 sm:max-w-lg sm:p-8 md:max-w-2xl md:p-10">
            ...
            >
              ...
              <div className="mt-6 flex gap-3">
                <button className="flex items-center gap-2 rounded-xl bg-white px-4 py-2 text-xs font-bold text-black transition hover:bg-white/90 active:scale-95 sm:px-5 sm:py-2.5 sm:text-sm">
                  <Play className="h-4 w-4 fill-black" />
                  Watch Now
                </button>
                <button className="flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-4 py-2 text-xs font-semibold text-white backdrop-blur-sm transition hover:bg-white/20 active:scale-95 sm:px-5 sm:py-2.5 sm:text-sm">
